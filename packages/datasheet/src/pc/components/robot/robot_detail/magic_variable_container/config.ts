...
export const map2Text = {
  ...
  to: t(Strings.robot_action_send_mails_config_4_pleaseholder),
  subject: t(Strings.robot_action_send_mails_config_5_pleaseholder),
  message: t(Strings.robot_action_send_mails_config_6_pleaseholder),
};
