...
export class FavoriteNodeInfo {
    ...
    */
    ...
    /**
    * The predecessor node ID of the favorite node
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "preFavoriteNodeId",
            "baseName": "preFavoriteNodeId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FavoriteNodeInfo.attributeTypeMap;
    }
