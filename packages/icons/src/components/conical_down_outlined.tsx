...
export const ConicalDownOutlined: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => <>
    <path d="M7.3683 13.4043C7.50615 13.6197 7.74426 13.75 8 13.75C8.25574 13.75 8.49385 13.6197 8.6317 13.4043L12.6317 7.15429C12.7794 6.92344 12.7895 6.63038 12.6579 6.38994C12.5263 6.14951 12.2741 6 12 6L4 6C3.72592 6 3.47366 6.14951 3.34208 6.38994C3.2105 6.63038 3.22055 6.92344 3.3683 7.15429L7.3683 13.4043ZM8 11.6087L5.37045 7.5L10.6296 7.5L8 11.6087Z" fill={ colors[0] } fillRule="evenodd" clipRule="evenodd"/>
