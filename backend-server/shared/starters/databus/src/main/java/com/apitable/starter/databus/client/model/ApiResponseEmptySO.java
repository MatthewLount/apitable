 ...
 */
@JsonPropertyOrder({
  ApiResponseEmptySO.JSON_PROPERTY_CODE,
  ApiResponseEmptySO.JSON_PROPERTY_DATA,
  ApiResponseEmptySO.JSON_PROPERTY_MESSAGE,
  ApiResponseEmptySO.JSON_PROPERTY_SUCCESS
})
