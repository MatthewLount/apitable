...
public class MailPropConstants {
    ...
    public static final String SUBJECT_VERIFY_CODE = "verificationCode";

    public static final String SUBJECT_REMOVE_MEMBER = "removeMember";

    public static final String SUBJECT_CAPACITY_FULL = "capacityFull";
    ...
    public static final String SUBJECT_REGISTER = "registerEmail";

    public static final String SUBJECT_PAI_SUCCESS = "paySuccess";

    public static final String SUBJECT_WARN_NOTIFY = "subject.warn.notify";

    public static final String SUBJECT_ADD_RECORD_SOON_LIMITED = "addRecordReachingLimited";

    public static final String SUBJECT_ADD_RECORD_LIMITED = "addRecordReachedLimited";

    public static final String SUBJECT_TASK_REMINDER = "taskReminder";
    ...
    public static final String SUBJECT_WIDGET_SUBMIT_SUCCESS = "widgetSubmitSuccess";
    ...
    public static final String SUBJECT_SUBSCRIBED_SEATS_LIMIT = "subscribedSeatsLimit";

    public static final String SUBJECT_SUBSCRIBED_RECORD_LIMIT = "subscribedRecordLimit";

    public static final String SUBJECT_SUBSCRIBED_API_LIMIT = "subscribedApiLimit";

    public static final String SUBJECT_SUBSCRIBED_CALENDAR_LIMIT = "subscribedCalendarLimit";

    public static final String SUBJECT_SUBSCRIBED_FORM_LIMIT = "subscribedFormLimit";

    public static final String SUBJECT_SUBSCRIBED_MIRROR_LIMIT = "subscribedMirrorLimit";
